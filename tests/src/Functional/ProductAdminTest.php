...
class ProductAdminTest extends StockBrowserTestBase {
  ...
  public function testCreateProductForm() {
    ...
    $this->assertSession()->checkboxChecked('variations[form][inline_entity_form][commerce_stock_always_in_stock][value]');
  ...
  public function testEditProduct() {
    ...
    $this->assertSession()->checkboxChecked('variations[form][inline_entity_form][entities][0][form][commerce_stock_always_in_stock][value]');
    ...
    $variations_edit = [
      'variations[form][inline_entity_form][entities][0][form][commerce_stock_always_in_stock][value]' => 0,
    ];
